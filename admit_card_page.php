...
<body>
    ...
    <div class="main_container">
        <div class="side_slide">
            ...
            <h3 class="short_header"> <a href="Resources.php" target="_blank"> Syllabus </a> </h3>
        </div>
        <center>
            <h3 class="header_text"> Admit Card </h3>
        </center>
        <div class="admit_container">
            <center>
                <h3 style="font-family: bitter; letter-spacing: 3px; "> Madan Mohan Malaviya University of Technology </h3>
            </center>
            <hr/>
            <div class="circle">
                <img class="main_pic" src="<?php echo($row['image']) ?>" alt="something">
            </div>
            <pre class="parameter"> <span> <bold>Student Name:</bold></span>  <?php echo($row['name']) ?></pre>
            <pre class="parameter"> <span> Branch:</span>             <?php echo($row['branch']) ?></pre>
            <pre class="parameter"> <span> Semester:</span>          <?php echo($row['semester']) ?>th</pre>
            <pre class="parameter"> <span> Year:</span>                 <?php echo($row['year_of_enrollment']) ?>nd</pre>
            <pre class="parameter"> <span> Father's Name:</span>  <?php echo($row['fathers_name']) ?></pre>
...
<?php }
    ...
    ob_start();
	Header("Location: ./admit_card.html");
	ob_end_flush();
    die();
}
?>
